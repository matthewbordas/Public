namespace BellaCode.Windows.Behaviors
{
    using System;
    ...
    /// <summary>
    /// Updates the binding source of a TextBox when the user is typing and pauses (application idle)
    /// </summary>
    /// <remarks>
    /// There is a 500 millisecond delay between evaluating pauses.
    /// </remarks>
